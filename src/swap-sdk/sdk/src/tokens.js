...
class CrocTokenView {
    ...
    constructor(context, tokenAddr) {
        ...
        if (this.isNativeEth) {
            ...
            this.decimals = this.resolve().then((c) => __awaiter(this, void 0, void 0, function* () { return c.decimals().then(Number); }));
        }
    }
    ...
    approveAddr(addr, approveQty) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const weiQty = approveQty !== undefined ? yield this.normQty(approveQty) : ethers_1.MaxUint256;
    ...
    allowance(address, spender) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (yield this.resolve()).allowance(address, spender ? spender : yield (yield this.context).dex.getAddress());
        });
    }
    roundQty(qty) {
        return __awaiter(this, void 0, void 0, function* () {
