...
// src/index.ts
init_esm_shims();
import { Metadata as Metadata3, Server as Server2, ServerCredentials, status } from "@grpc/grpc-js";
...
var AdminServiceClient = makeGenericClientConstructor(AdminServiceService, "AdminService");
