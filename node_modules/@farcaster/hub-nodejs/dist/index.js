...
__export(src_exports, {
  ...
  Metadata: () => import_grpc_js3.Metadata,
  Server: () => import_grpc_js3.Server,
  ServerCredentials: () => import_grpc_js3.ServerCredentials,
...
var SubscribeRequest = {
  ...
  fromPartial(object) {
    ...
    message.totalShards = object.totalShards ?? void 0;
...
var SyncStatusResponse = {
  ...
  fromPartial(object) {
    ...
    const message = createBaseSyncStatusResponse();
    message.isSyncing = object.isSyncing ?? false;
    message.syncStatus = ((_a = object.syncStatus) == null ? void 0 : _a.map((e) => SyncStatus.fromPartial(e))) || [];
...
var StreamSyncRequest = {
  ...
  fromJSON(object) {
    return {
      getInfo: isSet6(object.getInfo) ? HubInfoRequest.fromJSON(object.getInfo) : void 0,
      getCurrentPeers: isSet6(object.getCurrentPeers) ? Empty.fromJSON(object.getCurrentPeers) : void 0,
      stopSync: isSet6(object.stopSync) ? Empty.fromJSON(object.stopSync) : void 0,
      forceSync: isSet6(object.forceSync) ? SyncStatusRequest.fromJSON(object.forceSync) : void 0,
      getSyncStatus: isSet6(object.getSyncStatus) ? SyncStatusRequest.fromJSON(object.getSyncStatus) : void 0,
      getAllSyncIdsByPrefix: isSet6(object.getAllSyncIdsByPrefix) ? TrieNodePrefix.fromJSON(object.getAllSyncIdsByPrefix) : void 0,
      getAllMessagesBySyncIds: isSet6(object.getAllMessagesBySyncIds) ? SyncIds.fromJSON(object.getAllMessagesBySyncIds) : void 0,
      getSyncMetadataByPrefix: isSet6(object.getSyncMetadataByPrefix) ? TrieNodePrefix.fromJSON(object.getSyncMetadataByPrefix) : void 0,
      getSyncSnapshotByPrefix: isSet6(object.getSyncSnapshotByPrefix) ? TrieNodePrefix.fromJSON(object.getSyncSnapshotByPrefix) : void 0,
      getOnChainEvents: isSet6(object.getOnChainEvents) ? OnChainEventRequest.fromJSON(object.getOnChainEvents) : void 0,
      getOnChainSignersByFid: isSet6(object.getOnChainSignersByFid) ? FidRequest.fromJSON(object.getOnChainSignersByFid) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var StreamError = {
  ...
  fromJSON(object) {
    return {
      errCode: isSet6(object.errCode) ? String(object.errCode) : "",
      message: isSet6(object.message) ? String(object.message) : "",
      request: isSet6(object.request) ? String(object.request) : ""
    };
  },
  toJSON(message) {
    const obj = {};
...
var StreamSyncResponse = {
  ...
  fromJSON(object) {
    return {
      getInfo: isSet6(object.getInfo) ? HubInfoResponse.fromJSON(object.getInfo) : void 0,
      getCurrentPeers: isSet6(object.getCurrentPeers) ? ContactInfoResponse.fromJSON(object.getCurrentPeers) : void 0,
      stopSync: isSet6(object.stopSync) ? SyncStatusResponse.fromJSON(object.stopSync) : void 0,
      forceSync: isSet6(object.forceSync) ? SyncStatusResponse.fromJSON(object.forceSync) : void 0,
      getSyncStatus: isSet6(object.getSyncStatus) ? SyncStatusResponse.fromJSON(object.getSyncStatus) : void 0,
      getAllSyncIdsByPrefix: isSet6(object.getAllSyncIdsByPrefix) ? SyncIds.fromJSON(object.getAllSyncIdsByPrefix) : void 0,
      getAllMessagesBySyncIds: isSet6(object.getAllMessagesBySyncIds) ? MessagesResponse.fromJSON(object.getAllMessagesBySyncIds) : void 0,
      getSyncMetadataByPrefix: isSet6(object.getSyncMetadataByPrefix) ? TrieNodeMetadataResponse.fromJSON(object.getSyncMetadataByPrefix) : void 0,
      getSyncSnapshotByPrefix: isSet6(object.getSyncSnapshotByPrefix) ? TrieNodeSnapshotResponse.fromJSON(object.getSyncSnapshotByPrefix) : void 0,
      getOnChainEvents: isSet6(object.getOnChainEvents) ? OnChainEventResponse.fromJSON(object.getOnChainEvents) : void 0,
      getOnChainSignersByFid: isSet6(object.getOnChainSignersByFid) ? OnChainEventResponse.fromJSON(object.getOnChainSignersByFid) : void 0,
      error: isSet6(object.error) ? StreamError.fromJSON(object.error) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var StreamFetchRequest = {
  ...
  fromJSON(object) {
    return {
      idempotencyKey: isSet6(object.idempotencyKey) ? String(object.idempotencyKey) : "",
      castMessagesByFid: isSet6(object.castMessagesByFid) ? FidTimestampRequest.fromJSON(object.castMessagesByFid) : void 0,
      reactionMessagesByFid: isSet6(object.reactionMessagesByFid) ? FidTimestampRequest.fromJSON(object.reactionMessagesByFid) : void 0,
      verificationMessagesByFid: isSet6(object.verificationMessagesByFid) ? FidTimestampRequest.fromJSON(object.verificationMessagesByFid) : void 0,
      userDataMessagesByFid: isSet6(object.userDataMessagesByFid) ? FidTimestampRequest.fromJSON(object.userDataMessagesByFid) : void 0,
      linkMessagesByFid: isSet6(object.linkMessagesByFid) ? FidTimestampRequest.fromJSON(object.linkMessagesByFid) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var StreamFetchResponse = {
  ...
  fromJSON(object) {
    return {
      idempotencyKey: isSet6(object.idempotencyKey) ? String(object.idempotencyKey) : "",
      messages: isSet6(object.messages) ? MessagesResponse.fromJSON(object.messages) : void 0,
      error: isSet6(object.error) ? StreamError.fromJSON(object.error) : void 0
    };
  },
  toJSON(message) {
...
var HubServiceService = {
  ...
  getInfo: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(HubInfoRequest.encode(value).finish()),
    requestDeserialize: (value) => HubInfoRequest.decode(value),
    responseSerialize: (value) => Buffer.from(HubInfoResponse.encode(value).finish()),
    responseDeserialize: (value) => HubInfoResponse.decode(value)
  },
  getCurrentPeers: {
    ...
    responseSerialize: (value) => Buffer.from(ContactInfoResponse.encode(value).finish()),
    responseDeserialize: (value) => ContactInfoResponse.decode(value)
  },
  /** @http-api: none */
  stopSync: {
    ...
    requestSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
    requestDeserialize: (value) => Empty.decode(value),
    responseSerialize: (value) => Buffer.from(SyncStatusResponse.encode(value).finish()),
    responseDeserialize: (value) => SyncStatusResponse.decode(value)
  },
  /**
  ...
  forceSync: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(SyncStatusRequest.encode(value).finish()),
    requestDeserialize: (value) => SyncStatusRequest.decode(value),
    responseSerialize: (value) => Buffer.from(SyncStatusResponse.encode(value).finish()),
    responseDeserialize: (value) => SyncStatusResponse.decode(value)
  },
  /** @http-api: none */
  ...
  getAllSyncIdsByPrefix: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(TrieNodePrefix.encode(value).finish()),
    requestDeserialize: (value) => TrieNodePrefix.decode(value),
    responseSerialize: (value) => Buffer.from(SyncIds.encode(value).finish()),
    responseDeserialize: (value) => SyncIds.decode(value)
  },
  /** @http-api: none */
  getAllMessagesBySyncIds: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(SyncIds.encode(value).finish()),
    requestDeserialize: (value) => SyncIds.decode(value),
    responseSerialize: (value) => Buffer.from(MessagesResponse.encode(value).finish()),
    responseDeserialize: (value) => MessagesResponse.decode(value)
  },
  /** @http-api: none */
  ...
  getSyncSnapshotByPrefix: {
    ...
    requestSerialize: (value) => Buffer.from(TrieNodePrefix.encode(value).finish()),
    requestDeserialize: (value) => TrieNodePrefix.decode(value),
    responseSerialize: (value) => Buffer.from(TrieNodeSnapshotResponse.encode(value).finish()),
    responseDeserialize: (value) => TrieNodeSnapshotResponse.decode(value)
  },
  /** @http-api: none */
  streamSync: {
    ...
    requestStream: true,
    responseStream: true,
    requestSerialize: (value) => Buffer.from(StreamSyncRequest.encode(value).finish()),
    requestDeserialize: (value) => StreamSyncRequest.decode(value),
    responseSerialize: (value) => Buffer.from(StreamSyncResponse.encode(value).finish()),
    responseDeserialize: (value) => StreamSyncResponse.decode(value)
  },
  /** @http-api: none */
  streamFetch: {
    ...
    requestStream: true,
    responseStream: true,
    requestSerialize: (value) => Buffer.from(StreamFetchRequest.encode(value).finish()),
    requestDeserialize: (value) => StreamFetchRequest.decode(value),
    responseSerialize: (value) => Buffer.from(StreamFetchResponse.encode(value).finish()),
    responseDeserialize: (value) => StreamFetchResponse.decode(value)
  }
};
...
var AdminServiceClient = (0, import_grpc_js.makeGenericClientConstructor)(AdminServiceService, "AdminService");
