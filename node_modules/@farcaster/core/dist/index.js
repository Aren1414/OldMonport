...
__export(src_exports, {
  ...
  ContactInfoContentBody: () => ContactInfoContentBody,
  ...
  GossipAddressInfo: () => GossipAddressInfo,
  ...
  NameRegistryEventRequest: () => NameRegistryEventRequest,
  NetworkLatencyMessage: () => NetworkLatencyMessage,
  ...
  PingMessageBody: () => PingMessageBody,
  Protocol: () => Protocol,
  ...
  RentRegistryEventsRequest: () => RentRegistryEventsRequest,
  ...
  StreamFetchRequest: () => StreamFetchRequest,
  StreamFetchResponse: () => StreamFetchResponse,
  StreamSyncRequest: () => StreamSyncRequest,
  StreamSyncResponse: () => StreamSyncResponse,
  ...
  TrieNodePrefix: () => TrieNodePrefix,
  TrieNodeSnapshotResponse: () => TrieNodeSnapshotResponse,
  ...
  gossipVersionFromJSON: () => gossipVersionFromJSON,
  gossipVersionToJSON: () => gossipVersionToJSON,
...
function tierTypeFromJSON(object) {
  switch (object) {
    ...
    case "Pro":
      return 1 /* Pro */;
    default:
      throw new tsProtoGlobalThis4.Error("Unrecognized enum value " + object + " for enum TierType");
  }
}
...
var OnChainEvent = {
  ...
  fromJSON(object) {
    return {
      ...
      tierPurchaseEventBody: isSet4(object.tierPurchaseEventBody) ? TierPurchaseBody.fromJSON(object.tierPurchaseEventBody) : void 0,
...
var TierPurchaseBody = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.forDays = longToNumber4(reader.uint64());
          continue;
        case 3:
          if (tag != 26) {
            break;
  ...
  fromJSON(object) {
    return {
      tierType: isSet4(object.tierType) ? tierTypeFromJSON(object.tierType) : 0,
      forDays: isSet4(object.forDays) ? Number(object.forDays) : 0,
...
var TierDetails = {
  ...
  fromJSON(object) {
    return {
      tierType: isSet9(object.tierType) ? tierTypeFromJSON(object.tierType) : 0,
      expiresAt: isSet9(object.expiresAt) ? Number(object.expiresAt) : 0
    };
  },
  toJSON(message) {
    const obj = {};
...
var validateCastAddBody = (body, allowEmbedsDeprecated = false) => {
  ...
  if (body.embeds.length > 2) {
    return (0, import_neverthrow6.err)(new HubError("bad_request.validation_failure", "embeds > 2"));
  }
